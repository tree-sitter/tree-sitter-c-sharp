...
module.exports = grammar({
  ...
  rules: {
    ...
    // Tree-sitter already performs context-aware lexing, so most of these are not needed and commented out. The list is kept for completeness.
    // The uncommented keywords are required, and their purpose is recorded in test cases.
